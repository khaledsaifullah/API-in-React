...
// start: data assign in state varible in typescript page
...
console.log("PP", data)
// end: data assign in state varible in typescript page
    ...
    return (
        <div className='main-content-body'>
            <div className="container">
                <h2 className="h2 text-center mb-1">{t('VIRTUAL GALLERY2222')}</h2>


                {/* start: data display from API for API integration  */}
                <Row gutter={[16, 16]}>
                    {
                        data?.products.map((item: any, i: number) => (
                            <Col xs={24} md={4} key={i}>
                                <div className="shadow p-3 rounded-2">
                                <img src={item.thumbnail} alt="grd" style={{ "width": "100%","height":"200px" }} />
                 ...
                 {/* end: data display from API for API integration  */}
